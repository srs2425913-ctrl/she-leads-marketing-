...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-NDRKV5AX.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-NDRKV5AX.js")).default(client, args);
    case "add":
      return (await import("./add-DLK472F2.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-UMFXT335.js")).default(client, args);
    case "rm":
      return (await import("./rm-ZOVPEOPT.js")).default(client, args);
    case "update":
      return (await import("./update-G6D7GNBJ.js")).default(client, args);
    default:
